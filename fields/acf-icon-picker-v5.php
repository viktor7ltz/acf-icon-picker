...
if ( ! class_exists( 'acf_field_icon_picker_custom' ) ) :

	class acf_field_icon_picker_custom extends acf_field {
	...
	new acf_field_icon_picker_custom( acf_plugin_icon_picker::$settings );
